...
cs_table = [
  {
    "category": "가격비교",
    "result": "본 답변의 '가격비교' '원부' '카탈로그'는 동일한 의미로 사용되는 용어입니다. 답변 1(가격비교 매칭 방법) : 가격비교 매칭 방법은 'http://imgshopping.naver.net/admin/notice/g98cytj1o5y.png'을 참조해주세요. 답변 2(가격비교제외상품 : 공통안내) : 가격비교제외상품으로 나오는 경우 괄호 안에 가격비교 제외된 사유를 확인해주세요. 답변 3(가격비교제외상품 : 원부 내 포함대상이 아님) : 가격비교제외상품의 가격비교 제외 사유가 '원부 내 포함대상이 아님'일 경우 다음의 내용을 확인해주세요. 상품 기본정보(대표 이미지, 제조사, 브랜드, 상품명, 상품코드) 불일치, 여러 상품을 취급하는 모음전 상품은 매칭이 불가합니다. 1. 상품명에 상품코드가 없음\n적용 카테고리 : 디지털/가전, 식품, 화장품/미용\n[예시] 상품코드 추가\n삼성전자 정품 27인지 모니터 (X)\n삼성전자 S27R35A 27인치 모니터 (O)\n2. 상품명에 '용량/수량' 정보가 없음\n[예시] 용량 추가\n센트룸 실버 프로 멀티비타민 (X)\n센트룸 실버 프로 멀티비타민 1367mg x 120정 (O)\n3. 모음전 상품은 가격비교 매칭 불가\n- '택1' 등 선택형 상품, 모든 묶음형식 상품\n- 상품 및 조건을 여러 개 표기한 상품\n상품명이 가격비교명(조건)과 일치해야 합니다. 답변 4(가격비교제외상품 : 원부 배송비 기준 위반) : 가격비교제외상품의 가격비교 제외 사유가 '원부 배송비 기준 위반'일 경우 다음의 내용을 확인해주세요. 수량 단위로 배송비가 발생하거나, 가격비교 배송비 조건을 초과한 배송비 상품은 가격비교에서 제외됩니다.\n\n1. '수량별 배송비' 발생\n무게/부피가 실제 크지 않은데 특정 수량 단위로 배송비를 부과하는 상품\n[예시]\n샤오미 보조배터리 - 최대구매 수량 1개\n황사 마스크 - 10개당 배송비 부과\n→ 실제 발생하는 배송비로 수정해야 합니다.\n\n2. 가격비교 배송비 조건\n부피가 작은 상품군: 3,000원\n부피가 큰 상품군: 5,000원\n택배 배송비 불가능한 대형 상품군: 30,000원 답변 5(가격비교제외상품 : 원부 설치비 기준 위반): 가격비교제외상품의 가격비교 제외 사유가 '원부 설치비 기준 위반'일 경우 다음의 내용을 확인해주세요. 에어컨, 보일러, 온수기 등 설치가 필요한 상품은 상품명에 '기본설치비 포함' 및 상세페이지에 추가비용 정보를 표기하지 않으면 매칭이 불가합니다. 설치 상품군 서비스 기준은 'https://adcenter.shopping.naver.com/board/notice_detail.nhn?page=1&noticeType=&noticeSeq=274384&srchKey=cont&srchVal=%EC%84%A4%EC%B9%98%EB%B9%84'를 참조해주세요. 답변 6(가격비교제외상품 : 원부기준 위반_기타) : 가격비교제외상품의 가격비교 제외 사유가 '원부기준 위반_기타'일 경우 다음의 내용을 확인해주세요.가격비교 매칭 가이드에 맞지 않은 상품은 가격비교에 노출할 수 없습니다. 제외된 사유는 'https://adcenter.shopping.naver.com/board/notice_detail.nhn?page=1&noticeType=&noticeSeq=276064&srchKey=ttl&srchVal=%EB%A7%A4%EC%B9%AD'을 통해 확인 가능합니다. 답변  7(가격비교제외상품 : 원부 비대상 상품군) : 가격비교제외상품의 가격비교 제외 사유가 '원부 비대상 상품군'일 경우 가격비교를 서비스하지 않는 상품군으로 매칭이 불가능합니다. 상품 타입 : 중고, 리퍼, 전시, 반품, 스크래치 판매 방식 : 대여, 도매, 할부, 예약판매, 구매대행 답변 8(11번가, 쿠팡 등 오픈마켓 가격비교) : 11번가,쿠팡 상품의 가격비교 매칭 요청은 오픈마켓/종합몰을 통해 상품정보가 수신됩니다. 따라서, 해당 오픈마켓/종합몰 담당자에게 매칭 요청해주시기 바랍니다. 답변 9(가격비교 미노출 : 매칭상태 미확인) : 가격비교 매칭을 요청했는데 노출이 안되는 경우 매칭상태를 확인해주세요.가격비교 매칭상태를 확인 하는 방법은 가격비교를 요청했던 페이지 상품현황 및 관리> 서비스 상품 리스트에서 상품의 상태 및 요청 처리 결과를 확인할 수 있습니다. 표의 오른쪽 열에서 '상태'를 확인해주세요. 'https://adcenter.shopping.naver.com/iframe//product/manage/service/list.nhn'를 참조해주세요. 답변 10(가격비교 미노출 : 매칭완료) : 가격비교 매칭상태가 매칭완료인데 안나오는 경우 [가격비교 매칭완료] 처리 후, 쇼핑검색결과 반영까지 업데이트 시간이 소요됩니다. 최대 8시간 내에 검색결과에 반영(노출)됩니다. 답변 11(가격비교 미노출 : 추천중, 반려) : 가격비교 매칭 상태가 [추천중] 또는 [반려] 로 나오는 경우 다음과 같은 상품은 매칭이 불가능합니다. 1. 다른 옵션이 포함된 모음 상품명 2. 1개 또는 몇 개 단위 배송비 부과 상품 3. 원부와 사이즈,용량,수량이 다른 상품 답변 12(가격비교 매칭 기준) : 네이버쇼핑 가격비교 매칭 기준은 네이버 자체적으로 가격비교 서비스의 제공 및 각 상품의 매칭 필요성 여부를 판단하여 처리하고 있습니다. 자세한 기준은 'https://help.pay.naver.com/faq/content.help?faqId=13388'를 확인해주세요. 답변 13(가격비교 매칭 해제) : 가격비교 매칭 해제는 불가능합니다. 네이버쇼핑 등록 상품은 동일한 상품의 원부가 있을 경우, 가격비교 페이지 노출이 원칙입니다. 가격비교와 다른 상품만 '신고'하실 수 있습니다. 가격비교와 다른 상품을 '신고'하는 방법은 가격비교 페이지 내의 판매처 리스트에서 신고하기 버튼으로할 수 있습니다. '가격비교 대상이 아닌 상품이 포함되어 있음'을 체크하고, 내용 입력란에 상품이 다른 점을 기재해주세요. 현재, 신고는 처리까지 평일 기준 3일이 소요되고 있습니다. 답변 14(가격비교 수정) : 가격비교 이름과 이미지 속성 등을 임의로 수정하는 것은 불가능합니다. 다만 가격비교 페이지에 잘못된 정보가 있을 경우에만 수정 요청이 가능합니다. 정보 수정요청으로 잘못된 내용을 제보해주세요. 신고 내용을 정확히 선택하거나 '기타'를 선택 후 내용을 기재해주시기 바랍니다. 답변 15(가격비교 생성 방법) : 가격비교 페이지는 네이버 쇼핑 로직에 의해 자동 생성하며, 판매자의 요청에 의한 생성은 불가합니다. 판매자들에게 상품을 공급하는 상표권 보유 브랜드 본사는 '브랜드 패키지' 권한으로 가격비교 페이지를 생성할 수 있습니다. 답변 16(가격비교 생성 방법 : 브랜드 본사) : 판매자들에게 상품을 공급하는 상표권 보유 브랜드 본사는 [브랜드 관리] 메뉴에서 가격비교를 직접 생성 요청이 가능하며, 평일 2일 내 [처리내역 조회]에서 처리 결과를 조회할 수 있습니다. 생성 방법은 'http://imgshopping.naver.net/admin/notice/g9hbf6yi7vc.png'를 참조해주세요. 답변 17(가격비교 생성 : 상품 조회 불가) : [브랜드 관리]메뉴에서 상품 조회가 안 되는 경우는 다음의 사항을 확인해주세요. 1) 상품 정보에 [브랜드]를 입력하지 않은 상품 2) 품절 및 삭제 등 네이버쇼핑에서 노출중이 아닌 상품 답변 18(가격비교 생성 반려): 가격비교 생성이 [생성 반려]되는 경우 반려사유 획인 뒤, 카탈로그 관리 메뉴에서 반려 된 카탈로그를 조회하여 [변경 요청]해주시기 바랍니다."
  }
]
@app.get("/csTest")
async def get_available_slots(category: str):
    return cs_table

result_oos = [
  {
    "Step SEQ": "AB000100",
    "EINECN No": "ECO123456-X",
    "EINECN Title": "내용을 가볍게 아무거나 적어봅니다.",
    "PPID": "ABCA!12#",
    "result": "최근 수행된 나노스케일 반도체 실험에서 흥미로운 결과가 도출되었습니다. 300크기의 실리콘 기반 트랜지스터에서 예상을 뛰어넘는 성능이 관찰되었습니다.실험 과정에서 연구팀은 특수 제작된 300 웨이퍼를 사용하여 나노 구조를 형성했습니다. 이 구조는 기존 반도체보다 전류 누설이 30% 감소하고, 스위칭 속도가 25% 향상된 것으로 나타났습니다.특히 주목할 만한 점은 이 나노 구조가 고온에서도 안정적인 성능을 보였다는 것입니다. 300의 고온 환경에서도 성능 저하가 거의 없었으며, 이는 기존 반도체의 한계를 크게 뛰어넘는 결과입니다.이번 실험 결과는 차세대 반도체 개발에 새로운 가능성을 제시하며, 향후 더 작고 효율적인 전자기기 제작에 큰 도움이 될 것으로 기대됩니다."
  },
  {
    "Step SEQ": "AB000101",
    "EINECN No": "ECO123457-X",
    "EINECN Title": "내용을 가볍게 아무거나 적어봅니다.",
    "PPID": "ABCA!12#",
    "result": "최근 수행된 나노스케일 반도체 실험에서 흥미로운 결과가 도출되었습니다. 300 크기의 실리콘 기반 트랜지스터에서 예상을 뛰어넘는 성능이 관찰되었습니다.실험 과정에서 연구팀은 특수 제작된 300 웨이퍼를 사용하여 나노 구조를 형성했습니다. 이 구조는 기존 반도체보다 전류 누설이 30% 감소하고, 스위칭 속도가 25% 향상된 것으로 나타났습니다.특히 주목할 만한 점은 이 나노 구조가 고온에서도 안정적인 성능을 보였다는 것입니다. 300의 고온 환경에서도 성능 저하가 거의 없었으며, 이는 기존 반도체의 한계를 크게 뛰어넘는 결과입니다.이번 실험 결과는 차세대 반도체 개발에 새로운 가능성을 제시하며, 향후 더 작고 효율적인 전자기기 제작에 큰 도움이 될 것으로 기대됩니다."
  },
  {
    "Step SEQ": "AB000202",
    "EINECN No": "ECO123451-X",
    "EINECN Title": "내용을 가볍게 아무거나 적어봅니다.",
    "PPID": "ABCA!12#",
    "result": "최근 수행된 나노스케일 반도체 실험에서 흥미로운 결과가 도출되었습니다. 300 크기의 실리콘 기반 트랜지스터에서 예상을 뛰어넘는 성능이 관찰되었습니다.실험 과정에서 연구팀은 특수 제작된 300 웨이퍼를 사용하여 나노 구조를 형성했습니다. 이 구조는 기존 반도체보다 전류 누설이 30% 감소하고, 스위칭 속도가 25% 향상된 것으로 나타났습니다.특히 주목할 만한 점은 이 나노 구조가 고온에서도 안정적인 성능을 보였다는 것입니다. 300의 고온 환경에서도 성능 저하가 거의 없었으며, 이는 기존 반도체의 한계를 크게 뛰어넘는 결과입니다.이번 실험 결과는 차세대 반도체 개발에 새로운 가능성을 제시하며, 향후 더 작고 효율적인 전자기기 제작에 큰 도움이 될 것으로 기대됩니다."
  },
...
async def get_available_slots(date_time: str):
    if date_time in available_slots:
        ...
        raise HTTPException(status_code=400, detail="해당 시간에 예약 가능한 타석이 없습니다.")
...
async def reserve_slot(reservation: ReservationRequest):
    ...
    if date_time not in available_slots:
        raise HTTPException(status_code=500, detail="해당 시간에 예약 가능한 타석이 없습니다.")
...
new_movies = [
    ...
    },
    {
    	...
    	"actors": ["하정우", "성동일"],
    	"rating" : 8.5,
    	"audience_count" : 8390000,
    	"genre_code" : 6,
    	"reviews" : ["너무 잘만든 스포츠 영화", "최고의 OST"]
  },
  {
  	"title" : "듄: 파트2",
  	"year": 2024,
  	...
  	"actors": ["티모시 샬라메", "젠데이아"],
  	"rating" : 8.3,
  	"audience_count" : 2010000,
  	"genre_code" : 2,
  	"reviews" : ["아이맥스로 보세요", "웅장한 음악과 화려한 연출"]
  },
  {
  	"title" : "너의 결혼식",
  	"year": 2018,
  	...
  	"actors": ["박보영", "김영광"],
  	"rating" : 8.4,
  	"audience_count" : 2820000,
  	"genre_code" : 3,
  	"reviews" : ["사랑은 타이밍", "국내 로맨스 영화 탑"]
  },
  {
  	"title" : "레옹",
  	"year": 1995,
  	...
  	"genre_code" : 6,
  	"reviews" : ["말이 필요없는 명작", "Shape of my heart"],
  },
  {
  	"title" : "괴물",
  	"year": 2023,
  	"country_code" : 81,
  	"director" : "고레에다 히로카즈",
  	"actors": ["안도 사쿠라", "나가야마 에이타"],
  	"rating" : 8.9,
  	"audience_count" : 530000,
  	"genre_code" : 6,
  	"reviews" : ["꼭 봐야할 영화", "신의 경지에 이른 아역 캐스팅"],
  },
  {
  	"title" : "핸섬가이즈",
  	"year": 2024,
  	...
  	"actors": ["이성민", "이희준"],
  	"rating" : 7.8,
  	"audience_count" : 1770000,
  	"genre_code" : 1,
  	"reviews" : ["여름철 필수 코미디", "A급 배우들의 B급 연기"],
  },
  {
  	"title" : "브로커",
  	"year": 2022,
  	...
  	"actors": ["송강호", "아이유"],
  	"rating" : 6.4,
  	"audience_count" : 1260000,
  	"genre_code" : 6,
  	"reviews" : ["생명이 주제", "칸의 영화"],
  },
  {
  	"title" : "존 윅 4",
  	"year": 2023,
  	...
  	"genre_code" : 2,
  	"reviews" : ["스트레스를 모두 날릴 수 있다", "전설적인 액션"],
  },
  {
  	"title" : "존 오브 인터레스트",
  	"year": 2024,
  	"country_code" : 1,
  	"director" : "조나단 글래이저",
  	"actors": ["산드라 휠러", "크리스티안 프리에델"],
  	"rating" : 8.8,
  	"audience_count" : 200000,
  	"genre_code" : 6,
  	"reviews" : ["충격적 다큐멘터리", "악의 평범성"],
  },
  {
  	"title" : "해리 포터와 마법사의 돌",
  	"year": 2001,
  	"country_code" : 1,
  	"director" : "크리스 콜럼버스",
  	"actors": ["다니엘 래드클리프", "루퍼트 그린트"],
  	"rating" : 9.1,
  	"audience_count" : 1000000,
  	"genre_code" : 4,
  	"reviews" : ["20년이 지나도 황홀", "영원히 질리지 않을 영화"],
  },
  {
  	...
  	"genre_code" : 2,
  	"reviews" : ["B급인 척하는 S급 영화", "이 영화를 보고 영화감독을 포기했습니다"],
  },
  {
  	"title" : "극한직업",
  	"year": 2019,
  	...
  	"actors": ["류승룡", "이하늬"],
  	"rating" : 8.6,
  	"audience_count" : 16260000,
  	"genre_code" : 1,
  	"reviews" : ["코미디로 천만을 갈 수 있었던 이유", "수원왕갈비통닭"],
  },
  {
  	"title" : "명량",
  	"year": 2014,
  	...
  	"actors": ["최민식", "류승룡"],
  	"rating" : 7.3,
  	"audience_count" : 17610000,
  	"genre_code" : 2,
  	"reviews" : ["한국 대표 천만영화", "안 본 사람을 찾기가 더 어려운 작품"],
  },
  {
  	"title" : "베테랑",
  	"year": 2015,
  	...
  	"actors": ["황정민", "유아인"],
  	"rating" : 8.0,
  	"audience_count" : 13410000,
  	"genre_code" : 2,
  	"reviews" : ["코미디와 액션의 적절한 조화", "누구나 아는 명대사"],
  },
  {
  	"title" : "서울의 봄",
  	"year": 2023,
  	...
  	"actors": ["황정민", "정우성"],
  	"rating" : 8.0,
  	"audience_count" : 13120000,
  	"genre_code" : 6,
  	"reviews" : ["모두가 봐야할 영화", "배우들의 엄청난 연기력"],
  },
  {
  	"title" : "어바웃 타임",
  	"year": 2013,
  	...
  	"audience_count" : 5000000,
  	"genre_code" : 3,
  	"reviews" : ["행복하게 감동적이다", "모든 사람들의 인생영화"],
  },
  {
  	"title" : "행오버3",
  	"year": 2013,
  	...
  	"audience_count" : 500000,
  	"genre_code" : 1,
  	"reviews" : ["지구에서 제일 웃긴 영화", "코미디 영화계의 바이블"],
  }
